...
% multilead_P_waves = simECG_generate_multilead_P_waves() returns multilead
% (15 lead) simulated P waves. P waves are simulated using Hermite
...
%
% Output arguments:
% multilead_P_waves - multilead  simulated P waves.
% P_wave_params - struct of P wave simulation parameters
%
